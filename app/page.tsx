    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <section className="relative py-20 lg:py-32 bg-gradient-to-b from-[#FAFAFA] via-white to-[#FAFAFA] overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute -bottom-20 -right-20 w-[500px] h-[500px] bg-gradient-to-tl from-[#EFE6F8]/40 via-[#F3E4F2]/20 to-transparent rounded-full blur-[100px]" />
          <div className="absolute top-1/3 right-1/4 w-[400px] h-[300px] bg-[#7B61C9]/5 rounded-full blur-[100px]" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#7B61C9]/10 to-[#7B61C9]/5 text-[#7B61C9] text-sm font-medium mb-6 border border-[#7B61C9]/20"
              >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1A1A1A] mb-6">
                Meet{" "}
                <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">VulSphere</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="https://vulsphere.com"
                  className="inline-flex items-center gap-2 h-12 px-8 rounded-full bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] text-white hover:from-[#5B4A9E] hover:to-[#7B61C9] shadow-lg hover:shadow-xl hover:shadow-[#7B61C9]/25 transition-all duration-300 text-base font-medium"
                >
                  Request Demo
                ...
                <Link
                  href="#capabilities"
                  className="inline-flex items-center gap-2 h-12 px-8 rounded-full border-2 border-[#E8E8E8] text-[#1A1A1A] hover:border-[#7B61C9]/50 hover:bg-[#7B61C9]/5 transition-all duration-300 text-base font-medium"
                >
                  View Features
                </Link>
              </div>
            ...
            >
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-[#7B61C9]/20 to-transparent rounded-full blur-2xl" />
              <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-tr from-[#7B61C9]/10 to-transparent rounded-full blur-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-32 bg-[#FAFAFA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#7B61C9]/10 to-[#7B61C9]/5 text-[#7B61C9] text-sm font-medium mb-6 border border-[#7B61C9]/20">
              <AlertTriangle className="w-4 h-4" />
              <span>The Challenge</span>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Why Vulnerability Management{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Fails Today</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {problemCards.map((card, index) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="p-8 rounded-3xl bg-white border border-[#E8E8E8] hover:border-[#7B61C9]/30 hover:shadow-lg hover:shadow-[#7B61C9]/5 transition-all duration-300"
              >
                <div className="w-16 h-16 rounded-2xl bg-violet-50 flex items-center justify-center mb-6">
                  <card.icon className="w-8 h-8 text-[#7B61C9]" />
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1, duration: 0.5 }}
                whileHover={{ y: -4 }}
                className="p-8 rounded-3xl bg-white border border-[#E8E8E8] hover:border-[#7B61C9]/30 hover:shadow-lg hover:shadow-[#7B61C9]/5 transition-all duration-300 text-center"
              >
                <div className="w-16 h-16 rounded-2xl bg-[#7B61C9]/10 flex items-center justify-center mx-auto mb-4">
                  <stat.icon className="w-8 h-8 text-[#7B61C9]" />
                </div>
      ...
      <section id="capabilities" className="py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Powerful{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Capabilities</span>
            </h2>
            <p className="text-lg text-[#6A6A6A]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((capability, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1, duration: 0.5 }}
                whileHover={{ y: -4 }}
                className="p-6 rounded-3xl bg-white border border-[#E8E8E8] hover:border-[#7B61C9]/30 hover:shadow-lg hover:shadow-[#7B61C9]/5 transition-all duration-300 h-full"
              >
                <div className="w-12 h-12 rounded-2xl bg-[#7B61C9]/10 border border-[#7B61C9]/20 flex items-center justify-center mb-4">
                  <capability.icon className="w-6 h-6 text-[#7B61C9]" />
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#7B61C9]/10 to-[#7B61C9]/5 text-[#7B61C9] text-sm font-medium border border-[#7B61C9]/20">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A]">
                  Built for{" "}
                  <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Enterprise Scale</span>
                </h2>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {techStack.map((tech, index) => (
                  <motion.div
                    ...
                    transition={{ delay: index * 0.1, duration: 0.5 }}
                    whileHover={{ x: 8 }}
                    className="flex items-center gap-3 p-4 rounded-xl bg-white border border-[#E8E8E8] hover:border-[#7B61C9]/30 transition-all duration-300"
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#7B61C9]/10 flex items-center justify-center flex-shrink-0">
                      <tech.icon className="w-5 h-5 text-[#7B61C9]" />
                    </div>
      ...
      <section id="integrations" className="py-20 lg:py-32 bg-[#FAFAFA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Connects to Your{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Existing Tools</span>
            </h2>
            <p className="text-lg text-[#6A6A6A]">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {category.tools.map((tool) => (
                    <div
                      key={tool.name}
                      className="flex items-center gap-3 p-3 rounded-xl bg-[#FAFAFA] border border-[#E8E8E8] hover:border-[#7B61C9]/30 hover:bg-[#7B61C9]/5 transition-all duration-300"
                    >
                      {tool.logo ? (
                        ...
                        <div className="w-10 h-10 rounded-lg bg-[#7B61C9]/10 flex items-center justify-center flex-shrink-0">
                          <Scan className="w-5 h-5 text-[#7B61C9]" />
                        </div>
                      )}
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-b from-[#FAFAFA] via-white to-[#FAFAFA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Real{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Results</span>
            </h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <div>
                  <p className="text-sm font-medium text-[#7B61C9] mb-2">Expected Results</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-violet-100 flex items-center justify-center flex-shrink-0 mt-1">
                      <AlertTriangle className="w-4 h-4 text-[#7B61C9]" />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <div className="p-4 rounded-xl bg-[#7B61C9]/10 text-center">
                    <div className="text-3xl font-bold text-[#7B61C9]">73%</div>
                    <div className="text-sm text-[#6A6A6A]">Faster Remediation</div>
                  </div>
                  <div className="p-4 rounded-xl bg-[#7B61C9]/10 text-center">
                    <div className="text-3xl font-bold text-[#7B61C9]">95%</div>
      ...
      <section className="py-20 bg-[#FAFAFA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Audit-Ready{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Always</span>
            </h2>
            <p className="text-lg text-[#6A6A6A]">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {complianceBadges.map((badge, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-[#7B61C9]/10 flex items-center justify-center mx-auto mb-4">
                  <badge.icon className="w-8 h-8 text-[#7B61C9]" />
                </div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 lg:py-32 bg-gradient-to-b from-[#FAFAFA] via-white to-[#FAFAFA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Choose Your{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Plan</span>
            </h2>
            <p className="text-lg text-[#6A6A6A]">
            ...
            {pricingPlans.map((plan, index) => (
              <motion.div
                ...
                className={`relative p-8 rounded-3xl border transition-all duration-300 ${
                  plan.highlighted
                    ? "bg-gradient-to-b from-[#7B61C9]/5 to-white border-[#7B61C9]/30 shadow-xl shadow-[#7B61C9]/10"
                    : "bg-white border-[#E8E8E8] hover:border-[#7B61C9]/30 hover:shadow-lg hover:shadow-[#7B61C9]/5"
                }`}
              >
                {plan.highlighted && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <div className="px-4 py-1 rounded-full bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] text-white text-sm font-medium">
                      Recommended
                    </div>
                  </div>
                )}
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-3xl font-bold bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">
                    {plan.price}
                  </div>
                </div>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[#7B61C9] flex-shrink-0 mt-0.5" />
                ...
                <Link
                  href={plan.highlighted ? "https://vulsphere.com" : "https://vulsphere.com"}
                  className={`block w-full text-center py-3 px-6 rounded-full font-medium transition-all duration-300 ${
                    plan.highlighted
                      ? "bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] text-white hover:from-[#5B4A9E] hover:to-[#7B61C9] shadow-lg"
                      : "border-2 border-[#E8E8E8] text-[#1A1A1A] hover:border-[#7B61C9]/50 hover:bg-[#7B61C9]/5"
                  }`}
                >
                  {plan.cta}
                </Link>
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 lg:py-32 bg-[#FAFAFA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4">
              Frequently Asked{" "}
              <span className="bg-gradient-to-r from-[#7B61C9] to-[#2E7CF6] bg-clip-text text-transparent">Questions</span>
            </h2>
          </motion.div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-[#7B61C9] flex-shrink-0 transition-transform duration-300 ${
      ...
      {/* Final CTA Section */}
      <section className="py-20 lg:py-32 bg-gradient-to-br from-[#7B61C9] via-[#2E7CF6] to-[#7B61C9] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <Link
              href="https://vulsphere.com"
              className="inline-flex items-center gap-2 h-14 px-10 rounded-full bg-white text-[#7B61C9] hover:bg-white/90 shadow-xl hover:shadow-2xl transition-all duration-300 text-lg font-semibold"
            >
              Start Free Trial
              <ArrowRight className="w-5 h-5" />
            </Link>
